...
namespace vibrance.GUI.common
{
    public class ApplicationSetting
    {
        ...
        public ApplicationSetting(string name, string fileName, int ingameLevel, int ingameSDR, ResolutionModeWrapper resolutionSettings, bool isResolutionChangeNeeded)
        {
            this.Name = name;
            this.FileName = fileName;
            this.IngameLevel = ingameLevel;
            this.IngameSDR = ingameSDR;
